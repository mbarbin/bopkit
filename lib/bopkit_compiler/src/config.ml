...
let default = { optimize_cds = false; print_pass_output = []; parameters_overrides = [] }
...
let param =
  ...
  and parameters_overrides = Bopkit.Parameters.overrides in
  { optimize_cds; print_pass_output; parameters_overrides }
;;
